...
parser.add_argument('--n_train', type=int, default=[7000], help='number of training samples') # default=[3450]
...
parser.add_argument("--shuffle", default=True, action="store_true", help='shuffle')
...
parser.add_argument('--n_epochs', type=int, default=700, help='number of epochs to train')  # default=200
parser.add_argument('--patch_size', type=int, default=48, help='spatial resolution of training samples')
parser.add_argument('--batch_size', type=int, default=24, help='batch size for training') # default=64
...
# Transformer specificationss
parser.add_argument("--pre_norm", default=True, action="store_true", help='normalize_before_next_encoder')
